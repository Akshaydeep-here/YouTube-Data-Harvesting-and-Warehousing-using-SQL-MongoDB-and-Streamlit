...
# from app10 import get_channel_data
# from SQL11 import insert_data_to_mysql
import mysql.connector
from pymongo import MongoClient
...
def Extract_data(channel_ids):
    ...
    for channel in channel_data["items"]:
        try:
            ...
            channel={"channel data": channel_data,
                    "video data": video}
            ...
            print(" size of BSON file exceds mongodb limit. try another channel",e)
